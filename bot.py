...
def start(update, context):
    ...
    # a list (hence `[[...]]`).
    login_url = LoginUrl('https://isitnormal.to', request_write_access=True)
    keyboard = [
...
def main():
    ...
    updater.bot.set_webhook(f'https://{os.environ["PROJECT_NAME"]}.glitch.me/{token}')

    update_queue = updater.start_webhook('0.0.0.0', 8080, f'/{token}')
